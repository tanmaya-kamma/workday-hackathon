...
export function PendingApprovalsPage() {
  ...
  // Strictly scoped pending requests: request.managerId === currentUser.id && request.userId !== currentUser.id && request.status === 'pending'
