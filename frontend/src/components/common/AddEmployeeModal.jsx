...
export function AddEmployeeModal({ isOpen, onClose, onEmployeeAdded }) {
  ...
  useEffect(() => {
    if (isOpen) {
      ...
      api
        ...
        .catch((e) => {
          console.warn("Could not fetch managers list:", e);
        })
        .finally(() => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
       ...
       * IMPORTANT:
       *
       * Leave entitlement is NOT entered here anymore.
       *
       * The employee's leave balance is calculated by the
       * backend AccrualService using:
       *
       * - Date of joining
       ...
       * - Regional calendar
       *
       * Therefore annualLeave / sickLeave / casualLeave
       * are intentionally NOT included in this payload.
       */
      ...
      const payload = {
        ...
        date_of_joining: dateOfJoining
          ? new Date(dateOfJoining).toISOString()
          : undefined,
      ...
      <div className="bg-white rounded-2xl shadow-2xl border border-[#dfe5e8] w-full max-w-2xl max-h-[90vh] flex flex-col overflow-hidden animate-scale-up">
        ...
        <div className="p-6 border-b border-[#dfe5e8] flex items-center justify-between bg-[#f8fbfb]">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-[#0f1d27]">
                Add New Employee
              </h2>
        ...
        >
          ...
          {/* ====================================================
              DYNAMIC PTO INFORMATION
          ===================================================== */}

          <div className="p-4 bg-[#f8fbfb] rounded-xl border border-[#dfe5e8]">
            <div className="flex items-start gap-2">
              ...
              <div>
                <p className="text-xs font-bold uppercase tracking-wider text-[#0f1d27]">
                  Leave Balance Calculated Automatically
                </p>

                <p className="text-[11px] text-[#687781] mt-1 leading-relaxed">
                  Leave entitlement is calculated automatically based on the
                  employee's date of joining, organization leave policy, accrual
                  rules, tenure, and regional holiday calendar.
                </p>
              </div>
            </div>
          </div>
