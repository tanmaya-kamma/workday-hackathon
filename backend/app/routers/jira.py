...
async def leave_impact(
    ...
    return await jira_service.analyze_leave_impact(employee, start_date, end_date, manager=manager)
...
async def employee_list_link(
    ...
    return await jira_service.get_employee_jira_list_link(employee, manager=manager)
